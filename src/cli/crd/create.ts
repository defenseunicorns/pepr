...
const create = new Command("create")
  ...
  .option("-d, --domain [domain]", "Optional domain for CRD. Example: pepr.dev", "pepr.dev")
  .option(
    "-S, --scope [Namespaced|Cluster]",
    "Whether the resulting custom resource is cluster- or namespace-scoped. Default: Namespaced",
    validateScope,
    "Namespaced",
  )
  .option("-p, --plural <plural>", "Plural name for CRD. Example: memcacheds", "")
  .option("-s, --short-name [name]", "Short name for CRD. Example: mc", "")
