...
It is suggested to lint and format your modules using your own linting and formatting tools (e.g., ESLint and Prettier).
...
- Verify the source and build identity of Pepr npm releases by following the
  [release provenance guidance](https://docs.pepr.dev/reference/provenance).
