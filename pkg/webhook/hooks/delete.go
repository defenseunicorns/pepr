...
func delete(r *v1.AdmissionRequest) (*operations.Result, error) {
	message.Debugf("hooks.delete(*v1.AdmissionRequest) - %#v , %s/%s: %#v", r.Kind, r.Namespace, r.Name, r.Operation)
