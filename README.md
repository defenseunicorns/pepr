...
| [![codecov](https://codecov.io/github/defenseunicorns/pepr/graph/badge.svg?token=7679Y9K1HB)](https://codecov.io/github/defenseunicorns/pepr) | [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE-OF-CONDUCT) | |
...
- Lightweight async key-value store backed by K8s for stateful operations with the [Pepr Store](docs/user-guide/store)
...
- Least-privilege [RBAC](docs/user-guide/rbac) generation
...
For more details see [actions](docs/actions/) section.
...
See [Module](docs/user-guide/pepr-modules) for more details.
...
See [Capabilities](docs/user-guide/capabilities) for more details.
...
See [actions](docs/actions/) for more details.
