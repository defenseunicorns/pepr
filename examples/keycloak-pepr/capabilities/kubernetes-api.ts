...
class k8sAPI {
    ...
    async getSecretValue(namespace: string, secretName: string, key: string): Promise<string | undefined> {
        const response = await this.k8sApi.readNamespacedSecret(secretName, namespace);
